...
class Program
{
    static void Main(string[] args)
    {
        ...
        string passwordTwice = "Alice";
        int birthYear = 2000;
        bool checkAgeResult = checkAge(birthYear);
        createAccount(username,password,passwordTwice,birthYear, checkAgeResult);
    }
    ...
    static void createAccount(string username, string password, string passwordTwice, int birthYear, bool checkAgeResult){
